...
load("transcript_cleavage_7.RData")
x <- x %>% filter(Text3 != "")
...
x_7 <- x %>% mutate(
  ideology_scale7 = ifelse(cleavage_7_10 == 9 | cleavage_7_10 == 10, "7:Strong Agree",
                           ifelse(cleavage_7_10 == 7 | cleavage_7_10 == 8, "6:Agree",
                                  ifelse(cleavage_7_10 == 6, "5:Moderate Agree",
                                         ifelse(cleavage_7_10 == 5, "4:Neutral",
                                                ifelse(cleavage_7_10 == 4, "3:Moderate Disagree",
                                                       ifelse(cleavage_7_10 == 3 | cleavage_7_10 == 2, "2:Disagree",
                                                              ifelse(cleavage_7_10 == 1 | cleavage_7_10 == 0, "1:Strong Disagree", NA))))))),
  ideology_scale7 = factor(ideology_scale7))

frq(x_7$cleavage_7_10)
frq(x_7$ideology_scale7) # Manual Check if groups are correctly allocated

transcript_cleavage_7_doc_7 <- data.frame(frq(x_7$ideology_scale7))

transcript_cleavage_7 = NULL
y = NULL
...
for (i in vec) {
  ...
  transcript_cleavage_7 <- rbind(y, transcript_cleavage_7)
}

frq(transcript_cleavage_7$ideology_scale7)

#Removing extra scale to avoid error in coding
transcript_cleavage_7 <- transcript_cleavage_7 %>% select(-cleavage_7_10, -cleavage_7, -Text3)

# Create DFM  -----------------------------------------------------------------
transcript_cleavage_7 <- corpus(transcript_cleavage_7)

# Further cleaning procedure
transcript_cleavage_72 <- tokens(transcript_cleavage_7 , remove_punct = TRUE, remove_numbers=TRUE, remove_symbols = TRUE, 
                                 split_hyphens = TRUE, remove_separators = TRUE, remove_url = TRUE)
transcript_cleavage_72 <- tokens_remove(transcript_cleavage_72, c(stopwords("de"), "dass"))

transcript_cleavage_72 <- tokens_remove(transcript_cleavage_72, c("0*"))
transcript_cleavage_72 <- tokens_wordstem(transcript_cleavage_72, language = "german")
transcript_cleavage_72 <- dfm(transcript_cleavage_72)
topfeatures(transcript_cleavage_72 , 1000)  # 1000 top words

# Trimming 1: Remove features that only appear in 2 Tweet
transcript_cleavage_72 <- dfm_trim(transcript_cleavage_72 , min_docfreq = 35, verbose=TRUE)
transcript_cleavage_72  <- dfm_remove(transcript_cleavage_72 , min_nchar = 2)
topfeatures(transcript_cleavage_72 , 20)  # 20 top words

# Trimming 2: Remove doc with only 0
transcript_cleavage_72[ntoken(transcript_cleavage_72) == 0,]
transcript_cleavage_72  <-  transcript_cleavage_72[ntoken(transcript_cleavage_72) != 0,]
transcript_cleavage_72[ntoken(transcript_cleavage_72) == 0,]



transcript_cleavage_7_df <- transcript_cleavage_72 %>% 
  quanteda::convert(to = "data.frame") %>% 
  cbind(docvars(transcript_cleavage_72)) %>% 
  select(-doc_id)


# solving problem of features starting with digits eg 2x
names(transcript_cleavage_7_df) <- make.names(names(transcript_cleavage_7_df))

frq(transcript_cleavage_7_df$ideology_scale7)
transcript_cleavage_7_fea_7 <- data.frame(frq(transcript_cleavage_7_df$ideology_scale7))

# Task
ml_task <- makeClassifTask(data = transcript_cleavage_7_df, target = "ideology_scale7")
...
export(conf_matrix_knn, file = "TrCl7_confmatrix_knn.xlsx")
...
export(knn_1_fold, "pred_TrCl7_knn1.xlsx")
export(knn_2_fold, "pred_TrCl7_knn2.xlsx")
export(knn_3_fold, "pred_TrCl7_knn3.xlsx")
...
capture.output(bayesCV, file = "TrCl7_NB.txt")
...
export(conf_matrix_NB, file = "TrCl7_confmatrix_NB.xlsx")
...
export(nb_1_fold, "pred_TrCl7_nb1.xlsx")
export(nb_2_fold, "pred_TrCl7_nb2.xlsx")
export(nb_3_fold, "pred_TrCl7_nb3.xlsx")
...
export(conf_matrix_SVM, file = "TrCl7_confmatrix_SVM.xlsx")
...
export(svm_1_fold, "pred_TrCl7_svm1.xlsx")
export(svm_2_fold, "pred_TrCl7_svm2.xlsx")
export(svm_3_fold, "pred_TrCl7_svm3.xlsx")
...
export(conf_matrix_RF, file = "TrCl7_confmatrix_RF.xlsx")
...
export(rf_1_fold, "pred_TrCl7_rf1.xlsx")
export(rf_2_fold, "pred_TrCl7_rf2.xlsx")
export(rf_3_fold, "pred_TrCl7_rf3.xlsx")
