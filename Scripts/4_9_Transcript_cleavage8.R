...
load("transcript_cleavage_8.RData")
x <- x %>% filter(Text3 != "")
...
transcript_cleavage_8_doc_7 <- data.frame(frq(x_7$ideology_scale7))

transcript_cleavage_8 = NULL
y = NULL
...
for (i in vec) {
  ...
  transcript_cleavage_8 <- rbind(y, transcript_cleavage_8)
}

frq(transcript_cleavage_8$ideology_scale7)

#Removing extra scale to avoid error in coding
transcript_cleavage_8 <- transcript_cleavage_8 %>% select(-cleavage_8_10, -cleavage_8, -Text3)

# Create DFM  -----------------------------------------------------------------
transcript_cleavage_8 <- corpus(transcript_cleavage_8)

# Further cleaning procedure
transcript_cleavage_82 <- tokens(transcript_cleavage_8 , remove_punct = TRUE, remove_numbers=TRUE, remove_symbols = TRUE, 
                                 split_hyphens = TRUE, remove_separators = TRUE, remove_url = TRUE)
transcript_cleavage_82 <- tokens_remove(transcript_cleavage_82, c(stopwords("de"), "dass"))

transcript_cleavage_82 <- tokens_remove(transcript_cleavage_82, c("0*"))
transcript_cleavage_82 <- tokens_wordstem(transcript_cleavage_82, language = "german")
transcript_cleavage_82 <- dfm(transcript_cleavage_82)
topfeatures(transcript_cleavage_82 , 1000)  # 1000 top words

# Trimming 1: Remove features that only appear in 2 Tweet
transcript_cleavage_82 <- dfm_trim(transcript_cleavage_82 , min_docfreq = 20, verbose=TRUE)
transcript_cleavage_82  <- dfm_remove(transcript_cleavage_82 , min_nchar = 2)
topfeatures(transcript_cleavage_82 , 20)  # 20 top words

# Trimming 2: Remove doc with only 0
transcript_cleavage_82[ntoken(transcript_cleavage_82) == 0,]
transcript_cleavage_82  <-  transcript_cleavage_82[ntoken(transcript_cleavage_82) != 0,]
transcript_cleavage_82[ntoken(transcript_cleavage_82) == 0,]



transcript_cleavage_8_df <- transcript_cleavage_82 %>% 
  quanteda::convert(to = "data.frame") %>% 
  cbind(docvars(transcript_cleavage_82)) %>% 
  select(-doc_id)


# solving problem of features starting with digits eg 2x
names(transcript_cleavage_8_df) <- make.names(names(transcript_cleavage_8_df))

frq(transcript_cleavage_8_df$ideology_scale7)
transcript_cleavage_8_fea_7 <- data.frame(frq(transcript_cleavage_8_df$ideology_scale7))

# Task
ml_task <- makeClassifTask(data = transcript_cleavage_8_df, target = "ideology_scale7")
...
export(conf_matrix_knn, file = "TrCl8_confmatrix_knn.xlsx")
...
export(knn_1_fold, "pred_TrCl8_knn1.xlsx")
export(knn_2_fold, "pred_TrCl8_knn2.xlsx")
export(knn_3_fold, "pred_TrCl8_knn3.xlsx")
...
export(conf_matrix_NB, file = "TrCl8_confmatrix_NB.xlsx")
...
export(nb_1_fold, "pred_TrCl8_nb1.xlsx")
export(nb_2_fold, "pred_TrCl8_nb2.xlsx")
export(nb_3_fold, "pred_TrCl8_nb3.xlsx")
...
export(conf_matrix_SVM, file = "TrCl8_confmatrix_SVM.xlsx")
...
export(svm_1_fold, "pred_TrCl8_svm1.xlsx")
export(svm_2_fold, "pred_TrCl8_svm2.xlsx")
export(svm_3_fold, "pred_TrCl8_svm3.xlsx")
...
export(conf_matrix_RF, file = "TrCl8_confmatrix_RF.xlsx")
...
export(rf_1_fold, "pred_TrCl8_rf1.xlsx")
export(rf_2_fold, "pred_TrCl8_rf2.xlsx")
export(rf_3_fold, "pred_TrCl8_rf3.xlsx")